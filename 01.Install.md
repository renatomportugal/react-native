...
Next, Custom, Next, Dracula, Next, Selecione:
	Android SDK
	Android SDK Plataform (por padrão a API 29 também)
...
___Configuração no Android Studio 3.5.3___________________________________________
___Configure, SDK Manager
[Appearance & Behavior, System Settings, Android SDK, aba SDK Platforms]
Selecione Android 10.0 (Q)
